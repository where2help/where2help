...
class NeedsControllerTest < ActionController::TestCase
  ...
  test "should create need" do
    assert_difference('Need.count') do
      post :create, need: { end_time: @need.end_time, location: @need.location, skill: @need.skill, start_time: @need.start_time, volunteers_needed: @need.volunteers_needed }
    end
  ...
  test "should update need" do
    patch :update, id: @need, need: { end_time: @need.end_time, location: @need.location, skill: @need.skill, start_time: @need.start_time, volunteers_needed: @need.volunteers_needed }
    assert_redirected_to need_path(assigns(:need))
  end
