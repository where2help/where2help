    ...
    content_tag :div, class: "progress" do
      if current_user
        if signed_up <= needed
          ...
          content_tag(:div, content_tag(:i, "", class: "fa fa-smile-o fa-spin") +
                            " " + I18n.t("activerecord.attributes.shift.you"),
                      class: "progress-bar massive-font progress-bar-info progress-bar-striped active", style: "width: #{me}%" ) +
        ...
        if signed_up <= needed
          ...
          content_tag(:div, needed.to_s + " " + I18n.t("activerecord.attributes.shift.needed"),
                      class: "progress-bar massive-font progress-bar-striped progress-bar-success", style: "width: #{percentage}%" ) +
          content_tag(:div, (signed_up - needed ).to_s + " " + I18n.t("activerecord.attributes.shift.surplus"),
                      class: "progress-bar massive-font progress-bar-warning", style: "width: #{100 - percentage}%")
        end
      end
    end
  end
